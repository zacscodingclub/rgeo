  ...
  module CoordSys
    module CS
      ...
      class AxisInfo < Base
        ...
        def _wkt_content(_open, _close) # :nodoc:
      ...
      class Info < Base
        def initialize(name, authority = nil, authority_code = nil, abbreviation = nil, alias_ = nil, remarks = nil, extensions = nil) # :nodoc:
          @name = name
      ...
      class Unit < Info
        ...
        class << self
          ...
          def create(name_, conversion_factor_, *optional)
            new(name_, conversion_factor_, *optional)
          end
        end
      end
      ...
      class LinearUnit < Unit
        ...
        class << self
          ...
          def create(name_, meters_per_unit_, *optional)
            new(name_, meters_per_unit_, *optional)
          end
        end
      end
      ...
      class AngularUnit < Unit
        ...
        class << self
          ...
          def create(name_, radians_per_unit_, *optional)
            new(name_, radians_per_unit_, *optional)
          end
        end
      end
      ...
      class PrimeMeridian < Info
        ...
        class << self
          ...
          def create(name_, angular_unit_, longitude_, *optional)
            new(name_, angular_unit_, longitude_, *optional)
          end
        end
      end
      ...
      class Ellipsoid < Info
        ...
        class << self
          ...
          def create(name_, semi_major_axis, semi_minor_axis, inverse_flattening, ivf_definitive_, linear_unit, *optional)
            new(name_, semi_major_axis, semi_minor_axis, inverse_flattening, ivf_definitive_, linear_unit, *optional)
          end
      ...
      class VerticalDatum < Datum
        ...
        class << self
          ...
          def create(name_, datum_type, *optional)
            new(name_, datum_type, *optional)
          end
        end
      end
      ...
      class HorizontalDatum < Datum
        ...
        class << self
          ...
          def create(name, datum_type, ellipsoid_, wgs84_parameters_, *optional)
            new(name, datum_type, ellipsoid_, wgs84_parameters_, *optional)
          end
        end
      end
      ...
      class Projection < Info
        ...
        class << self
          ...
          def create(name, class_name, parameters_, *optional)
            new(name, class_name, parameters_, *optional)
          end
        end
      end
      ...
      class CompoundCoordinateSystem < CoordinateSystem
        ...
        class << self
          ...
          def create(name_, head_, tail_, *optional)
            new(name_, head_, tail_, *optional)
          end
        end
      end
      ...
      class LocalCoordinateSystem < CoordinateSystem
        ...
        class << self
          ...
          def create(name_, local_datum_, unit_, axes_, *optional)
            new(name_, local_datum_, unit_, axes_, *optional)
          end
        end
      end
      ...
      class GeocentricCoordinateSystem < CoordinateSystem
        def initialize(name_, horizontal_datum, prime_meridian, linear_unit, axis0, axis1, axis2, *optional) # :nodoc:
          super(name_, 3, *optional)
        ...
        class << self
          ...
          def create(name_, horizontal_datum, prime_meridian, linear_unit, axis0, axis1, axis2_, *optional)
            new(name_, horizontal_datum, prime_meridian, linear_unit, axis0, axis1, axis2_, *optional)
          end
        end
      end
      ...
      class VerticalCoordinateSystem < CoordinateSystem
        def initialize(name_, vertical_datum, vertical_unit, axis, *optional) # :nodoc:
          super(name_, 1, *optional)
        ...
        class << self
          ...
          def create(name_, vertical_datum, vertical_unit, axis, *optional)
            new(name_, vertical_datum, vertical_unit, axis, *optional)
          end
        end
      end
      ...
      class HorizontalCoordinateSystem < CoordinateSystem
        def initialize(name_, horizontal_datum, *optional) # :nodoc:
          super(name_, 2, *optional)
          @horizontal_datum = horizontal_datum
        end
      ...
      class GeographicCoordinateSystem < HorizontalCoordinateSystem
        ...
        class << self
          ...
          def create(name_, angular_unit_, horizontal_datum, prime_meridian, axis0, axis1, *optional)
            new(name_, angular_unit_, horizontal_datum, prime_meridian, axis0, axis1, *optional)
          end
        end
      end
      ...
      class ProjectedCoordinateSystem < HorizontalCoordinateSystem
        def initialize(name_, geographic_coordinate_system, projection, linear_unit, axis0, axis1, *optional) # :nodoc:
          super(name_, geographic_coordinate_system.horizontal_datum, *optional)
        ...
        def _wkt_content(open, close) # :nodoc:
          ...
          @projection.each_parameter { |param| arr << param._to_wkt(open, close) }
        ...
        class << self
          ...
          def create(name_, geographic_coordinate_system, projection, linear_unit, axis0, axis1, *optional)
            new(name_, geographic_coordinate_system, projection, linear_unit, axis0, axis1, *optional)
          end
        end
      end
    end
